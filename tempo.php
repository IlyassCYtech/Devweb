...
?>
<!DOCTYPE html> <html lang="fr" class="light"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1"> <title>Mes Objets | CY Tech</title> <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css"> <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" /> <style> .glass-effect { background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); }
...
</head> <body class="bg-gray-50 min-h-screen"> <nav class="glass-nav fixed w-full z-50 top-0 glass-effect"> <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <div class="flex justify-between items-center h-16"> <div class="flex"> <div class="flex-shrink-0 flex items-center"> <img class="h-8 w-auto" src="../assets/images/CY_Tech.png" alt="CY Tech Logo"> </div> </div>
...
que le truc ou je clique marche uniquement quand je controle lobjet dans les objet utilisee quoi

fait moi un fichier admin_objet.php

ou je peux voir tout les objet sur la carte

You have hit the rate limit. Please 
 to keep chatting, or you can continue coding for free in the editor.