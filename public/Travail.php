...
<!-- Main Content -->
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12" style="background-image: url('../assets/images/fond.jpg'); background-size: cover; background-position: center;">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 mb-2">Barre de recherche!</h1>
        <p class="text-gray-600">Découvrez votre ville à travers ses objets connectés!</p>
    </div>
            ...
            fetch(`search_user.php?q=${encodeURIComponent(query)}`)
                ...
                .then(data => {
                    ...
                    data.forEach(user => {
                        ...
                        userCard.innerHTML = `
                            <img src="${user.profile_pic_path}" alt="Photo de profil" class="w-12 h-12 rounded-full mr-4">
                            <div>
